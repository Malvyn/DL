...
class Config:
    def __init__(self):
        ...
        self.lr = 0.0001
        self.epoches = 200
        self.save_path = 'models/p17_my_update/my_update'
        self.hidden_size = 4
    ...
    def __init__(self, config: Config):
        ...
        with tf.device('/gpu:0'):
            with tf.variable_scope('stock'):
                ...
                cell = MyUpdateCell(config.stocks, config.hidden_size)
...
class MyUpdateCell:
    ...
    def __call__(self, state, xi, name):
        ...
        with tf.variable_scope(name):
            ...
            input_gate = 1 - update_gate

            state = state * update_gate + tf.nn.tanh(tf.layers.dense(merge, self.hidden_size, name='dense')) * input_gate
